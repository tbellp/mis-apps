...
====================
<a href="https://platform.telerik.com/#appbuilder/clone/https%3A%2F%2Fgithub.com%2FIcenium%2Fsample-accelerometer" target="_blank"><img src="http://docs.telerik.com/platform/samples/images/try-in-appbuilder.png" alt="Try in the Platform" title="Try in the Platform" /></a>  
...
This sample shows you how to use the Device Motion core plugin to access the accelerometer sensor of the mobile device.
...
Platform | Home | Active Accelerometer
---|---|---
All | ![](https://raw.githubusercontent.com/Icenium/Sample-Accelerometer/master/screenshots/home.png) | ![](https://raw.githubusercontent.com/Icenium/Sample-Accelerometer/master/screenshots/accelerometer-started.png)
...
1. Run the clone command for the sample as listed by `appbuilder sample`.
	...
	```bash
	appbuilder sample clone accelerometer
	```
